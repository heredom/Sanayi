			...
			<div id="sync1" class="owl-carousel">
				<div class="item">
					<div class="slide-desc">
						<div class="inner">
							<h1>Sanayi Ürünleri Platformu</h1>
				...
				<div class="item">
					<div class="slide-desc">
						<div class="inner">
							<h1>Firma Memnuniyet Garantisi</h1>
							<p>
							Hızlı, Güvenilir, Pratik.
Profesyonel tedarikçi-müşteri ilişkileri
				...
				<div class="item">
					...
					<div class="slide-type-1">
						<img src="images\termal.png" alt="" class="img-responsive">
					</div>
				</div>
				<div class="item">
					<div class="slide-desc">
